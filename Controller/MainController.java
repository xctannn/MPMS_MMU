...
public class MainController {
    ...
    public MainController(){
        ...
        this.loginController = new LoginController(null);
        this.registerController = new RegisterController(null);
        this.projectController = new ProjectController(new Administrator());

        // mainView.add(loginController.getLoginView(), "login", 0);
        // mainView.add(loginController.getRegisterView(), "register", 1);
    ...
    public void switchProjectView(Administrator adminUser){
        mainView.remove(2);
        this.projectController = new ProjectController(adminUser);
    ...
    public void switchProjectView(Lecturer lecturerUser){
        mainView.remove(2);
        this.projectController = new ProjectController(lecturerUser);
    ...
    public void switchProjectView(Student studentUser){
        mainView.remove(2);
        this.projectController = new ProjectController(studentUser);
